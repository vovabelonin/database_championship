--представления для возможности анализа игроков,их очков ,их команд,команд противников
--очков команд,команда победитель,главных судей


use NewLb
if (OBJECT_ID ('player_analyt') IS NOT NULL)
  DROP VIEW player_analyt;
GO
CREATE VIEW player_analyt AS 
